...
В данном репозитории представлены обязательные для скачивания моды: automodpack, ferritcore и modernfix. Остальные моды - клиентские моды на оптимизацию, которые рекомендуется поставить. Все основные моды будут автоматически докачены во время захода на сервер.
