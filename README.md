...
Сборку можно характеризовать как стимпанк, центром которого является технологический мод create и его аддон create aeronautics, с большим акцентом на исследование мира, строительство и готовку. Генерация обычного мира обеспечивается Terralith, Biomes We've Gone и Continents. В данном репозитории представлены обязательные для скачивания моды: automodpack, ferritcore и modernfix. Остальные моды - клиентские моды на оптимизацию, которые рекомендуется поставить. Все основные моды будут автоматически докачены во время захода на сервер.
